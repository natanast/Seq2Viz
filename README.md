...
**Seq2Viz** is an interactive Shiny application designed for performing RNA-seq differential expression analysis using DESeq2 and generating quick, publication-quality visualizations. 

Whether you need to run the DESeq2 analysis from scratch or upload pre-computed results, Seq2Viz allows users to seamlessly process their gene counts and metadata to generate visualizations such as Volcano plots, PCA plots, and Heatmaps.
...
Seq2Viz was developed and tested using **R version 4.5.3**.\
To ensure full compatibility, the app requires **R version 4.5.3 or higher**.\
